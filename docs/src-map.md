...
- **`atomic_state.py`** — Collision-safe atomic JSON publication for workspace state records.
...
- **`discord_task.py`** — Pure Discord task-envelope construction for the Discord adapter.
